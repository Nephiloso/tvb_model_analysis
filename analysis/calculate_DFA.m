...
function [DFAExponent,DFAIntercept,meanDF,windowSizes] = calculate_DFA(Signal, ComputeInterval, FitInterval, sampling_frequency, windowOverlap)
...
assert(ComputeInterval(2)*sampling_frequency<=lengthSignal,'Largest window size should be longer than the signal');
